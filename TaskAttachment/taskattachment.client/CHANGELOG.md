...
- Create Angular project with ng: `ng new taskattachment.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`taskattachment.client.esproj`).
